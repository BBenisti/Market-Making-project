...
SPREAD_MARKET_MULTIPLIER = 1.5   # quote at 1.5x the observed market spread
MIN_SPREAD_BPS = 0.5             # absolute floor
MAX_SPREAD_BPS = 20              # ceiling
VOL_SENSITIVITY = 0.5            # additional spread per unit of vol
VOL_WINDOW_SECONDS = 60
MIN_TICKS_FOR_VOL = 10
SPREAD_REFERENCE_SIZE = 1

# Market making — dynamic quote sizing
BASE_QUOTE_SIZE_BTC = 1.0
